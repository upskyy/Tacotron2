...
class PostNet(nn.Module):
    ...
    Args:
        n_mel (int, optional): The number of mel filters.
        postnet_dim (int, optional): Dimension of postnet.
        num_layers (int, optional): The number of convolution layers.
        kernel_size (int, optional): Value of convolution kernel size.
...
class ConvBNBlock(nn.Module):
    ...
    Args:
        ...
        dropout (float, optional): Probability of dropout.
        activation (str, optional): 'relu', 'tanh', None. (default : 'tanh')
